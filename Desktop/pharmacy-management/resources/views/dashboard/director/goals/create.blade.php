                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('goals.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name') }}" class="form-control" placeholder="Enter goal name" required>
                            @error('name')
                                <div class="text-danger small">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="description" name="description" rows="3" class="form-control" placeholder="Enter goal description">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="text-danger small">{{ $message }}</div>
                            @enderror
                        </div>
